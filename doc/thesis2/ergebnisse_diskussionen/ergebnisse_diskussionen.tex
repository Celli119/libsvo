...
Die in Abbildung \ref{david_lucy_xyzrgb_s1_vs_24_D13} dargestellte Vergleich der Messergebnisse für unterschiedliche Treelet-Größen zeigt für alle drei Modelle ähnliche Tendenzen auf.\\
\begin{figure}[position=h]
  \centering
...
\subsection{Auswertung}
Abbildung \ref{ratio_0_1} stellt die gemessene Zeit für das Kopieren, die Anzahl von geänderten Slots und die für die durchgeführten Kopieroperationen dar. Dabei besagt ein Anteil von 0, dass kopierte Bereiche keine Nutzdaten enthalten müssen. Ein Anteil von 1 bedeutet dagegen, dass jeder in einem zu kopierenden Bereich liegender Slot auch geänderte Daten enhalten muss. In der Abbildung lässt sich ein Optimum für einen Nutzdatenanteil von 0.6 erkennen. Mit dieser Einstellung betrug die Zeit für die Übertragung im Durchschnitt 2.48 ms. Zum Vergleich lag die Zeit für das separate Kopieren einzelner Slots im Durchschnitt bei 4.23 ms. Der im Graph nicht sichtbare Wert für einen Nutzdatenanteil von 0 lag bei 52.51 ms.\\
