...
/// svo system includes
#include <CpuRaycasterSingleRay4.h>
...
CpuRaycasterSingleRay4::CpuRaycasterSingleRay4(bool verboseMode):
  _svo(0),
  _pushCounter(0),
  _popCounter(0),
  _whileCounter(0)
...
CpuRaycasterSingleRay4::~CpuRaycasterSingleRay4()
{
...
CpuSvoNode
CpuRaycasterSingleRay4::traversSvo(SvoNode* rootNode, gloost::Point3 p, gloost::Vector3 d)
{
