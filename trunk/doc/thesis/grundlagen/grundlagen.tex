...
\begin{figure}[position=h]
  \centering
  \includegraphics[width=0.32\textwidth]{grundlagen/figures/cut_volume.pdf}
...
\begin{figure}[position=h]
  \centering
  \includegraphics[width=0.32\textwidth]{grundlagen/figures/cut_octree.pdf}
...
\begin{figure}[position=h]
  \centering
  \includegraphics[width=0.32\textwidth]{grundlagen/figures/cut_svo.pdf}
...
\begin{figure}[position=h]
  \centering
  \includegraphics[width=0.75\textwidth]{grundlagen/figures/raycasting.pdf}
  \caption{Schnitt durch einen Sparse Voxel Octree \label{cut_svo}}
\end{figure}

\section{Out-of-Core-Strategien}
...
\begin{figure}[position=h]
  \centering
  \includegraphics[width=0.75\textwidth]{grundlagen/figures/out_of_core_principal.pdf}
