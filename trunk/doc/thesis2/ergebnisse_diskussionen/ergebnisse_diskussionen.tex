...
Zum Testen des Out-of-Core Systems wurden SVO-Strukturen aus drei unterschiedliche Dreiecksg\-eometrien generiert (siehe Tabelle \ref{verwendete_mesh_modelle}). 
Aus jedem Modell wurden zwei verschiedene SVO-Strukturen erstellt. Beide haben jeweils die selbe minimale Tiefe von 13, aber eine unterschiedliche Treelet Größe. Die Tiefe betrug jeweils 12 bei Treelet Größen von 1kb und 4kb. Durch die Verkleinerung der Treelets bei gleicher minimaler SVO-Tiefe entstehen mehr Treelets und damit eine größerer Aufwand bei der Verwaltung. Die beiden Varianten sollen im folgenden verglichen werden, um die Skalierbarkeit des Out-of-Core Systems nach zu vollziehen. In Tabelle ... wird gezeigt... .
...
\caption{Verwendete Dreicksmodelle}\label{verwendete_mesh_modelle}
\end{table}
...
\begin{tabular}{ l  r  r  r  r }
  ...
  \hline
  david face        & 1kb & 743.277 &  95.139.456 & 1.4 GB \\
                    & 4kb & 484.297 & 247.960.064 & 3.7 GB \\
  \hline
  xyzrgb statuette  & 1kb & 781.302 & 100.006.656 & 1.5 GB \\
                    & 4kb & 246.434 & 126.174.208 & 1.9 GB \\
  \hline  
  Lucy              & 1kb & 588.032  & 75.268.096 & 1.2 GB \\
                    & 4kb & 131.072  & 67.108.864 & 1.0 GB \\
  \hline
\end{tabular}

\caption{Verwendete Sparse Voxel Octrees}\label{verwendete_svo_modelle}
\end{table}
